...
public class TimeUtils {
    ...
    private static final SimpleDateFormat[] ACCEPTED_TIMESTAMP_FORMATS = {
            new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss Z", DEFAULT_LOCALE),
            new SimpleDateFormat("EEE MMM dd HH:mm:ss yyyy", DEFAULT_LOCALE),
            new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", DEFAULT_LOCALE),
            new SimpleDateFormat("yyyy-MM-dd HH:mm:ss Z", DEFAULT_LOCALE),
            new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ", DEFAULT_LOCALE),
            new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", DEFAULT_LOCALE),
            new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'", DEFAULT_LOCALE),
            new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss Z", DEFAULT_LOCALE)
    };
    ...
    public static Date parseTimestamp(String timestamp) {
        for (SimpleDateFormat format : ACCEPTED_TIMESTAMP_FORMATS) {
            //We shouldn't be forcing the time zone when parsing dates.
    ...
    private static TimeZone getDisplayTimeZone(Context context) {
